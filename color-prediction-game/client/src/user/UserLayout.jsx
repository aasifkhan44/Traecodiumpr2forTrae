...
import { FaHome, FaGamepad, FaUser, FaHistory, FaShareAlt, FaSignOutAlt, FaUsers, FaWallet } from 'react-icons/fa';
      ...
      <header className="bg-white dark:bg-gray-800 shadow">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-primary">{siteSettings.siteName || 'Color Prediction Game'}</h1>
          </div>
      ...
      <footer className="bg-white dark:bg-gray-800 shadow mt-auto">
        <div className="container mx-auto px-4 py-4">
          <p className="text-center text-gray-600 dark:text-gray-400 text-sm">
            © {new Date().getFullYear()} Color Prediction Game. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
