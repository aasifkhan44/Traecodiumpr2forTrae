    ...
    const fetchGameData = async () => {
      try {
        ...
        if (response.data.success) {
          const nummaGame = response.data.data.find(game => game.identifier === 'Numma');
          if (nummaGame) {
            setGameData(nummaGame);
          } else {
            setError('Numma game not found or inactive');
          }
        } else {
