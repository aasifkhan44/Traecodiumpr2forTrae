    ...
    const fetchGameData = async () => {
      try {
        ...
        if (response.data.success) {
          const ludoGame = response.data.data.find(game => game.identifier === 'Ludo');
          if (ludoGame) {
            setGameData(ludoGame);
          } else {
            setError('Ludo game not found or inactive');
          }
        } else {
  ...
  return (
    <div className="game-container p-4">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-primary mb-4">Welcome to Ludo</h1>
        <p className="text-lg text-gray-600 mb-4">
          Classic multiplayer board game with exciting twists and rewards!
        </p>
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden md:flex">
        <div className="md:flex-shrink-0">
          <div className="h-48 w-full md:w-48 bg-gradient-to-r from-indigo-500 to-purple-500">
        ...
        <div className="p-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            <li>Multiplayer support (2-4 players)</li>
            <li>Classic Ludo gameplay</li>
            <li>Real-time dice rolling</li>
            <li>Tournament mode available</li>
          </ul>
          <div className="mt-6">
            <button 
