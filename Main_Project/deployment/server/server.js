...
// --- CORS CONFIGURATION ---
// Dynamically generate allowedOrigins from env
...
app.use(cors({
  origin: function (origin, callback) {
    ...
    const normalizedOrigins = allowedOrigins.map(o => o.trim().toLowerCase());
    if (normalizedOrigins.includes(origin.trim().toLowerCase())) {
