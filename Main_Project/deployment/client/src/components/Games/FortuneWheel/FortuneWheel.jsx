    ...
    const fetchGameData = async () => {
      try {
        ...
        if (response.data.success) {
          const fortuneWheelGame = response.data.data.find(game => game.identifier === 'FortuneWheel');
          if (fortuneWheelGame) {
            setGameData(fortuneWheelGame);
          } else {
            setError('Fortune Wheel game not found or inactive');
          }
        } else {
  ...
  return (
    <div className="game-container p-4">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-primary mb-4">Welcome to Fortune Wheel</h1>
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden md:flex">
        <div className="md:flex-shrink-0">
          <div className="h-48 w-full md:w-48 bg-gradient-to-r from-pink-500 to-orange-500">
        ...
        <div className="p-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            ...
            <li>Bonus spins and multipliers</li>
            <li>Daily free spins</li>
            <li>Special event wheels</li>
          </ul>
          <div className="mt-6">
            <button 
